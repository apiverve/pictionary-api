// Package pictionary provides a Go client for the Pictionary Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/pictionary?utm_source=go&utm_medium=readme
package pictionary
...
const (
	baseURL        = "https://api.apiverve.com/v1/pictionary"
	defaultTimeout = 30 * time.Second
)

// Client is the Pictionary Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Pictionary Generator API client.
...
// Execute makes a request to the Pictionary Generator API with typed parameters.
//
...
//   - count: integer - Number of words to generate [min: 1, max: 50]

# Pictionary Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:pictionary-api:1.1.12'
}
```
...
```java
import com.apiverve.pictionary.PictionaryGeneratorAPIClient;
import com.apiverve.pictionary.APIResponse;
import com.apiverve.pictionary.APIException;

// Initialize the client
PictionaryGeneratorAPIClient client = new PictionaryGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/pictionary](https://docs.apiverve.com/ref/pictionary)
...
- **Documentation:** [https://docs.apiverve.com/ref/pictionary](https://docs.apiverve.com/ref/pictionary)
- **Issues:** [GitHub Issues](https://github.com/apiverve/pictionary-api/issues)

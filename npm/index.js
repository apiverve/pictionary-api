...
class pictionaryWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/pictionary');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/pictionary';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"difficulty":{"type":"string","required":false,"default":"medium"},"count":{"type":"integer","required":false,"min":1,"max":50,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/pictionary`);
        }
    }
...
module.exports = pictionaryWrapper;
